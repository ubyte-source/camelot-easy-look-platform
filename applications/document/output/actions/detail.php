...
use applications\document\output\forms\Detail as Project;

$application_basename = IAMConfiguration::getApplicationBasename();
if (Sso::youHaveNoPolicies($application_basename . '/document/output/action/detail')) Output::print(false);
...
$project->getField('id_project')->setProtected(false)->setValue($id_project);
...
Output::concatenate(Output::APIDATA, $detail_value);
Output::print(true);
