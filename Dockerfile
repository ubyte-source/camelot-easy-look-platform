...
RUN apk update && \
    ...
    apk add --no-cache php81-fpm php81-openssl php81-pdo php81-zip php81-bcmath php81-pdo_mysql php81-curl php81-ctype php81-phar php81-iconv php81-common php81-mbstring php81-fileinfo && \
